...
class Settings(BaseSettings):
    ...
    YOOKASSA_SAVE_PAYMENT_METHOD: str = 'on_request'  # always / on_request / never
    YOOKASSA_RECURRING_ENABLED: bool = False
    YOOKASSA_RECURRING_CHECK_INTERVAL_MINUTES: int = 60
    YOOKASSA_RECURRING_RETRY_ATTEMPTS: int = 3
    YOOKASSA_RECURRING_RETRY_INTERVAL_HOURS: int = 6
